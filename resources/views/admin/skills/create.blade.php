<div class="modal fade" id="addskills" role="dialog" aria-labelledby="addskills" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
                    ...
                    <div class="modal-header">
                            <h5 class="modal-title">{{ __('skills.create_title') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                    </div>

                    <form action="{{ route('admin.skills.store') }} " method="post" id="skillsForm" name="skillsForm"  data-url="{{ route('check.exist') }}"  >
                        @csrf
