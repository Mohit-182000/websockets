<div class="modal fade" id="addknown_languages" role="dialog" aria-labelledby="addknown_languages" aria-hidden="true">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
                    ...
                    <div class="modal-header">
                            <h5 class="modal-title">{{ __('known_languages.create_title') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                    </div>

                    <form action="{{ route('admin.known-languages.store') }} " method="post" id="known_languagesForm" name="known_languagesForm" data-url="{{ route('check.exist') }}">
                        @csrf
