...
@section('page_title',__('exam_updates.create_title'))
@section('button')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                     ...
                     <form action="{{ route('admin.exam-updates.store') }}" method="post" id="exam_updatesForm" name="exam_updatesForm" data-url="{{ route('check.exist') }}">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="title" maxLength="50" name="title" data-rule-required="true" >
                                </div>

                                 <div class="form-group ">
                                    <label for="fees">{{ __('exam_updates.form.fees') }}<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="fees" name="fees" data-rule-required="true" data-rule-number="true" >
                                 </div>

                                <div class="form-group">
                                    <label for="lastdate">{{ __('exam_updates.form.lastdate') }}<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control commonDatepicker" id="last_date_of_exam" name="last_date_of_exam" placeholder="dd/mm/yyyy" autocomplete="off" data-rule-required="true">
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                  ...
                                  <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="no_of_post" name="no_of_post" data-rule-required="true" data-rule-number="true" >
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="age_limit"  name="age_limit" data-rule-required="true" data-rule-number="true">
                                </div>
                            
                                <div class="form-group">
                                    <label for="link">{{ __('exam_updates.form.link') }}<span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="link" name="link" data-rule-required="true" >
                                </div>
