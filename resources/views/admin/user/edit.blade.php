...
@section('page_title',__('user.edit_title'))
@section('button')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                     ...
                     <form action="{{ route('admin.user.update',$user->id) }}" method="post" id="userForm" name="userForm" enctype="multipart/form-data" data-url="{{ route('check.exist') }}">
                        ...
                        <div class="form-row">
                                 ...
                                 <div class="col-md-12  pr-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" id="name" value="{{$user->name ?? ''}}" data-rule-required="true" class="form-control">
                                         </div>

                                        <div class="form-group">
                                            <label for="email">{{ __('user.form.email') }} <span class="text-danger">*</span> </label>
                                            <input type="text" name="email" id="email" value="{{$user->email ?? ''}}" data-rule-required="true" class="form-control">
                                         </div>

                                        <div class="form-group">
                                            <label for="file">{{ __('user.form.profile') }} <span class="text-danger">*</span> </label>
                                            <input type="file" name="file" id="file" value="{{$user->profile ?? ''}}" class="form-control">
                                         </div>

                                         <div class="form-group">
                                            <label>{{ __('user.form.cpwd') }} <span class="text-danger">*</span> </label>
                                            <input type="password" name="password" id="password" value=""  data-rule-minlength="8" class="form-control">
                                         </div>

                                        <div class="form-group">
                                            <label>{{ __('user.form.password') }} <span class="text-danger">*</span> </label>
                                            <input type="password" name="confirm_password" value=""  data-rule-minlength="8" data-rule-equalTo="#password" class="form-control">
                                         </div>
