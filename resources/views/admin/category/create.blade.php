    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
                    ...
                    <div class="modal-header">
                            <h5 class="modal-title">{{ __('category.create_title') }}</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                    </div>

                    <form action="{{ route('admin.category.store') }} " method="post" id="categoryForm" name="categoryForm"  data-url="{{ route('check.exist') }}"  >
                        @csrf
                                    ...
                                    <div class="col-md-12  pr-3">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <select class="form-control select2" name="parent_id" id="parent_id"  data-rule-required="false" data-url="{{ route('get.category') }}"></select>
                                        </div>
