$(document).ready(function () {
    ...
    function createAddress(e) {
        ...
        var address = '<p>'+ mainaddress.address_one+'<br>';
        if(mainaddress.address_two) {
            address += mainaddress.address_two+'<br>';
        }
        if(mainaddress.contact_person_phone) {
            address +=  'Phone: ' + mainaddress.contact_person_phone+'<br>';
        }
        address +=  'Emal: ' + data.email || '' +'</p>'
