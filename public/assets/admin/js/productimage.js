...
var myDropzone = $('.dropzone').dropzone({
    ...
    init: function () {
        ...
        this.on('addedfile', function (file, dataUrl) {
            ...
            // create alt input            
            $('<input/>', { type: 'text',name: 'alt[]', class: 'hidden','data-uuid': file.upload.uuid }).appendTo(f);
            $('<input/>', { type: 'text', name: 'images_id[]', class: 'hidden', value: file.id}).appendTo(f);
            $('<input/>', { type: 'text', name: 'file_id[]', class: 'hidden', value: file.upload.uuid}).appendTo(f);
    ...
    success : function(file) {
        ...
        if (file.id) {
            ...
            $('<input/>', {type: 'text', name: 'alt[]', class: 'hidden', 'data-uuid': file.upload.uuid , value: file.alt }).appendTo(f);
            $('<input/>', {type: 'text', name: 'images_id[]', class: 'hidden', value: file.id}).appendTo(f);
            $('<input/>', {type: 'text', name: 'file_id[]', class: 'hidden', value: file.upload.uuid}).appendTo(f);
            // add data-id based on current length
